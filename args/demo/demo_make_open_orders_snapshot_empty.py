...
def main() -> int:
    ap = argparse.ArgumentParser(prog="demo_make_open_orders_snapshot_empty")
    ap.add_argument("--out", default="args/data/ibkr_open_orders_empty.jsonl")
    args = ap.parse_args()
    ...
    rows = [
        ...
        # intentionally NO IBKR_OPEN_ORDER rows
        {
